...
if(file.exists(x = here::here("MSstats_Output_data/msts_data_noprotw1pep.Rda")) == FALSE){ # check if Rda file with the data is already available. 
      ...
      save(msts_data_noprotw1pep, file = here::here("MSstats_Output_data/msts_data_noprotw1pep.Rda")) # save Rda file for faster loading later if required
      
      if(dir.exists(here::here("MSstats_Output_data/MSstats_formated_tables")) == FALSE){dir.create(here::here("MSstats_Output_data/MSstats_formated_tables"))}
      
      write.csv(x = msts_data_noprotw1pep, file = here::here("MSstats_Output_data/MSstats_formated_tables/msstats_data_noprotw1pep.csv")) # noprotw1pe means 'this file does not contains proteins that were identified only with 1 peptide". 
} else {
      
      load(here::here("MSstats_Output_data/msts_data_noprotw1pep.Rda")) # load the Rda file if available.
